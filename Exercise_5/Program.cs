...
namespace Exercise_5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Даны натуральное число n, действительная квадратная матрица порядка n.\n" +
                              "Построить последовательность из нулей и единиц, в которой i-й элемент = 1 тогда и только тогда," +
                              " когда в i-й строке матрицы есть хотя бы один отрицательный элемент.\n");
